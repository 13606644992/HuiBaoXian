...
+(void)setTabBarViewNav
{
    ...
    balanceNav.tabBarItem.image = [UIImage imageNamed:@"ico@3x"];
    ...
    walletNav.tabBarItem.image = [UIImage imageNamed:@"ico@3x"];
    ...
    checkNav.tabBarItem.image = [UIImage imageNamed:@"ico@3x"];
    ;
    ...
    myNav.tabBarItem.image = [UIImage imageNamed:@"ico@3x"];
    ;
